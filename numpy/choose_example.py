...
index_array = [0,0,0,1] # array indices(=first axis) I'm going to choose
...
choices = matrix(7,3)
a = [1,3, 0] # row(=first axis) indices of choices I'm going to choose
...
index_array = np.array([0, 2, 1, 3]) # row(=first axis) indices of choices I'm going to choose
choose_example(index_array, choices) 
